	...
	<footer class="site-footer">
		<div class="container-fluid -column">
			...
			<nav class="footer-social" aria-label="Footer social navigation">
				<ul class="nav-list -social">
					<li class="nav-item -social">
						<a class="nav-link -social" aria-label="Like Johnston Community College on Facebook" href="https://goo.gl/oxQ3Sf" title="Permaink to: Like Johnston Community College on Facebook. Link opens in a new window." target="_blank">
							...
							<span class="screen-reader-text">Johnston Community College on Facebook</span></a>
					</li>
					<li class="nav-item -social">
						<a class="nav-link -social" aria-label="Follow Johnston Community College on Twitter" href="https://goo.gl/3VgxKv" title="Permaink to: Follow Johnston Community College on Twitter. Link opens in a new window." target="_blank">
							...
							<span class="screen-reader-text">Johnston Community College on Twitter</span></a>
					</li>
					<li class="nav-item -social">
						<a class="nav-link -social" aria-label="Follow Johnston Community College on Instagram" href="https://goo.gl/3HhrnC" title="Permaink to: Follow Johnston Community College on Instragram. Link opens in a new window." target="_blank">
							...
							<span class="screen-reader-text">Johnston Community College on Instagram</span></a>
					</li>
					<li class="nav-item -social">
						<a class="nav-link -social" aria-label="Subscribe to Johnston Community College on YouTube" href="https://goo.gl/yy3F5L" title="Permaink to: Subscribe Johnston Community College on YouTube. Link opens in a new window." target="_blank">
							...
							<span class="screen-reader-text">Johnston Community College on YouTube</span></a>
					</li>
				</ul>
			</nav>
			<div class="footer-address">
				...
				<a aria-label="Call Johnston Community College at (919) 934-3051" href="tel:919-934-3051" title="Call Johnston Community College at (919) 934-3051">(919) 934-3051</a>
			</div>
		</div>
	</footer>
